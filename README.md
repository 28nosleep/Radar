...
Персональная разведывательная лента для одного владельца. Текущий Milestone M3 —
...
3. **M3 — GitHub, Reddit и YouTube (текущий).** Добавляются API-коллекторы и снимки
   метрик. X не входит в этап.
4. **M4 — Discovery.** Дельты stars/upvotes/comments/views, скорость роста,
   всплески одной темы в независимых источниках и новые быстрорастущие сущности.
